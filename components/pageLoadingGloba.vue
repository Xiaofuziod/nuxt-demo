<template>
  <div class="loading-overlay" v-show="globalShow">
    <div class="loading">
      <div id="logo">
        <div class="symbol">
          <div>
            <img src="@/assets/imgs/login/l0.svg" alt="">
          </div>
          <div></div>
          <div></div>
          <div></div>
        ...
        <div class="symbol">
          <div style="background: #8AC3B0">
            <img src="@/assets/imgs/login/l1.svg" alt="">
          </div>
          <div></div>
          <div></div>
          <div></div>
        ...
        <div class="symbol">
          <div><img src="@/assets/imgs/login/l2.svg" alt=""></div>
          <div></div>
          <div></div>
          <div></div>
          <div></div>
        ...
        <div class="symbol">
          <div><img src="@/assets/imgs/login/l3.svg" alt=""></div>
          <div></div>
          <div></div>
          <div></div>
          <div></div>
        ...
        <div class="symbol">
          <div><img src="@/assets/imgs/login/l4.svg" alt=""></div>
          <div></div>
          <div></div>
          <div></div>
          <div></div>
